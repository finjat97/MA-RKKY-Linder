...
def main(sites_x, sites_y, mu, cps, tri, jott, gamma, imp1, imp2):
    ...
    spin_1 = [0, 0.5, 0] #spin components of impurity spin
    spin_2 = [0, -0.5, 0]
    ...
    #### let's get to work
    if spin_opti:
        positions =[[13,17], [15,25]] #[[5, 15], [35, 45], [20,70]] # [[1,2],[1,3]] #
        ...
        # analytical_results = analytical.main()
        # dump(analytical_results, 'analytical.txt', compress=2)
        # dump([free_energies, spin_configs, parameters], 'numerical.txt', compress=2)
        # plot.analytical_vs_numerical(analytical_results[0], free_energies[0], analytical_results[1], parameters, spin_configs)
